...
class Button(Label):
    ...
    def _return_hover_rendering(self):
        ...
        main_body = graphics.draw.render_dynamic_rect(pygame.Rect(pos, size), self['hover_bg'], self['cornerradius'],
                                                      orient=self['gradial_orient'],
                                                      gradient_blend=self['gradient_blend'])
        border_rect = graphics.draw.render_dynamic_rect(pygame.Rect(0, 0, *self.rect.size), self['hover_bc'],
    ...
    def _return_active_rendering(self):
        ...
        main_body = graphics.draw.render_dynamic_rect(pygame.Rect(pos, size), self['active_bg'], self['cornerradius'],
                                                      orient=self['gradial_orient'],
                                                      gradient_blend=self['gradient_blend'])
        border_rect = graphics.draw.render_dynamic_rect(pygame.Rect(0, 0, *self.rect.size), self['active_bc'],
                                                        self['cornerradius'], orient=self['gradial_orient'],
                                                        gradient_blend=self['gradient_blend'])
    ...
    def _render(self):
        ...
        self._render_style = [selected[0].copy(),
                              selected[1].copy()]
...
class CheckButton(ToggleButton):
    ...
    def _return_rendering(self):
        ...
        bg_body = graphics.draw.render_dynamic_rect(pygame.Rect(pos, size), self['background'], self['cornerradius'],
                                                    orient=self['gradial_orient'])

        main_body = graphics.draw.render_dynamic_rect(pygame.Rect(pos2, size2), (0, 0, 0, 0), self['cornerradius'] - 1,
                                                      orient=self['gradial_orient'])
    ...
    def _return_active_rendering(self):
        ...
        main_body = graphics.draw.render_dynamic_rect(pygame.Rect(pos2, size2), self['active_bg'],
                                                      self['cornerradius'] - 1, orient=self['gradial_orient'])
...
class RadioButton(CheckButton):
    ...
    def _return_rendering(self):
        ...
        main_body = graphics.draw.dynamic_render_ellipse(pos2, self['cornerradius']-4, self['cornerradius']-4, self['background'],
                                                 orient=self['gradial_orient'], gradient_blend=self['gradient_blend'])

        bg_body = graphics.draw.dynamic_render_ellipse(pos2, self['cornerradius'], self['cornerradius'],
                                               [self['inactive_bg']]*2,
                                               orient=self['gradial_orient'], gradient_blend=self['gradient_blend'])

        border_rect = graphics.draw.dynamic_render_ellipse(pos2, self.rect.width//2, self.rect.width//2, self['bordercolor'],
                                                   orient=self['gradial_orient'], gradient_blend=self['gradient_blend'])
