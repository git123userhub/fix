...
def button_style(
    ...
    style = dict(borderwidth=borderwidth, cornerradius=cornerradius,
                ...
                gradial_orient=gradial_orient, gradient_blend=gradient_blend
                )
...
def checkbutton_style(
    ...
    style = dict(borderwidth=borderwidth, cornerradius=cornerradius,
                ...
                foreground=(0, 0, 0, 0),
                active_fg=(0, 0, 0, 0),
                active_bc=bordercolor, gradient_blend=gradient_blend
                )
...
def slider_style(
    ...
    style = dict(bar_borderwidth=bar_borderwidth, bar_cornerradius=bar_cornerradius,
                 ...
                 grip_gradient_blend=grip_gradient_blend,
                 bar_gradial_orient=bar_gradial_orient,
                 bar_gradient_blend=bar_gradient_blend)
